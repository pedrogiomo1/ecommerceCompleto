...
<section class="content">
  ...
  <div class="row">
  	<div class="col-md-12">
        ...
        <!-- /.box-header -->
        <!-- form start -->
        <form role="form" action="/admin/products2/create" method="post">
          <div class="box-body">
            ...
            <div class="form-group">
              <label for="vllenght">Comprimento</label>
              <input type="number" class="form-control" id="vllenght" name="vllenght" step="0.01" placeholder="0.00">
            </div>
            <div class="form-group">
